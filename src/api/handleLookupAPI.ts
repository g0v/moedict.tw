...
const LOOKUP_CORS_ALLOWLIST = new Set([
  "https://moedict.tw",
  "https://old.moedict.tw",
  "http://old.moedict.tw",
  "https://www.moedict.org",
...
export function parsePinyinLookupPath(
  pathname: string,
): { lang: LookupLang; type: string; term: string } | null {
...
async function readLookupTitles(
  env: LookupEnv,
  lang: LookupLang,
  type: string,
  term: string,
...
async function readLookupTitleMap(
  env: LookupEnv,
  lang: LookupLang,
  type: string,
...
export async function handleLookupAPI(
  request: Request,
  url: URL,
  env: LookupEnv,
